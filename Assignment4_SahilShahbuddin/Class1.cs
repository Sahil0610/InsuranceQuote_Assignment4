...
public class DefaultSuiteTest
{
    ...
    {
        driver.Navigate().GoToUrl("http://localhost/prog8170a04%20-%20section%2003/prog8170a04/index.html");
        ...
        driver.FindElement(By.Id("email")).SendKeys("sahil@gmail.com");
    ...
    public void insuranceQuote04()
    {
        ...
        driver.FindElement(By.Id("postalCode")).SendKeys("N2L 0K6");
        driver.FindElement(By.Id("phone")).Click();
        driver.FindElement(By.Id("phone")).SendKeys("1234-1234-1234");
        driver.FindElement(By.Id("email")).Click();
        driver.FindElement(By.Id("email")).SendKeys("sahil@gmail.com");
        driver.FindElement(By.Id("age")).Click();
        driver.FindElement(By.Id("age")).Click();
    ...
    public void insuranceQuote05()
    {
        ...
        driver.FindElement(By.Id("phone")).SendKeys("123-123-1234");
        driver.FindElement(By.Id("email")).Click();
        driver.FindElement(By.Id("email")).SendKeys("sahil@gmail@gmail@com");
        driver.FindElement(By.Id("age")).Click();
        driver.FindElement(By.Id("age")).Click();
    ...
    public void insuranceQuote06()
    {
        ...
        driver.FindElement(By.Id("city")).SendKeys("Waterloo");
        driver.FindElement(By.Id("postalCode")).Click();
        driver.FindElement(By.Id("postalCode")).SendKeys("A1234");
        driver.FindElement(By.Id("phone")).Click();
        driver.FindElement(By.Id("phone")).SendKeys("123-123-1234");
        driver.FindElement(By.Id("email")).Click();
        driver.FindElement(By.Id("email")).SendKeys("sahil@gmail.com");
